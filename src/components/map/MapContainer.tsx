...
export function MapContainer() {
    ...
    const getPopupContent = (driver: Driver) => {
        return `<div class="flex flex-col gap-2 bg-white dark:bg-gray-800 rounded-lg p-2">
    ...
    useEffect(() => {
        const handleOpenPopup = (event: CustomEvent<string>) => {
            ...
            popupRef.current = new mapboxgl.Popup({
                ...
                .setHTML(getPopupContent(driver))
